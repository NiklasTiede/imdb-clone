...
from popcorn_society_agent.settings import load_runtime_secrets, load_settings
...
async def _run(*, live: bool, case_id: str | None, progress: bool) -> int:
    ...
    if live:
        ...
        if not settings.live_evals_enabled:
            print(
                "Live evals are disabled. Set POPCORN_SOCIETY_AGENT_LIVE_EVALS_ENABLED=true "
