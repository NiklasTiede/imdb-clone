...
# test data
insert into IMDBCLONE.movie(primary_title,original_title,start_year,end_year,RUNTIME_MINUTES,modified_at_in_utc,created_at_in_utc,MOVIE_GENRE,MOVIE_TYPE,IMDB_RATING,IMDB_RATING_COUNT,ADULT) values ('Le clown et ses chiens','Le clown et ses chiens',1988, 1989, 120, null, null, 2433, 1,5.8,4299, 0);
...
insert into IMDBCLONE.watched_movie(movie_id,account_id) values(1457767,1);
insert into IMDBCLONE.watched_movie(movie_id,account_id) values(1396484,1);
insert into IMDBCLONE.watched_movie(movie_id,account_id) values(1457767,2);
