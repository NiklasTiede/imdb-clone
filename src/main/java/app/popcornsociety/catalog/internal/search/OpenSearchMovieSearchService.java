...
import static app.popcornsociety.catalog.internal.search.MovieSearchMetrics.Mode.DISCOVERY;
import static app.popcornsociety.catalog.internal.search.MovieSearchMetrics.Mode.FILTER_ONLY;
import static app.popcornsociety.catalog.internal.search.MovieSearchMetrics.Mode.LEXICAL_FALLBACK;
import static app.popcornsociety.catalog.internal.search.MovieSearchMetrics.Mode.SEMANTIC;
import static app.popcornsociety.catalog.internal.search.MovieSearchMetrics.Mode.TITLE;
import static app.popcornsociety.shared.logging.Log.MOVIE_ID;
...
import app.popcornsociety.catalog.internal.search.index.MovieSearchEmbeddingTextBuilder;
import app.popcornsociety.catalog.internal.search.query.MovieSearchQueryBuilder;
import app.popcornsociety.catalog.internal.search.query.MovieSearchQueryIntentClassifier;
import app.popcornsociety.catalog.internal.search.query.MovieSearchRankFusion;
