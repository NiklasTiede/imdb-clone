...
values(1,'testMovieOnePri','testMovieOneOri',2010,2010,100,16409,1,8.0,528339,0,null,0,'Awesome movie.','superUrlTokenOne');
insert into movie(id, primary_title, original_title, start_year, end_year, runtime_minutes, movie_genre, movie_type, imdb_rating, imdb_rating_count, adult, rating, rating_count, description, image_url_token)
values(2,'testMovieTwoPri','testMovieTwoOri',2014,2014,90,16409,1,7.0,67839,0,null,0,'Super movie.','superUrlTokenTwo');
