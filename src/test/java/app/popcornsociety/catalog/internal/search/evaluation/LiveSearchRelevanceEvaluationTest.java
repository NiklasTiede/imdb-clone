package app.popcornsociety.catalog.internal.search.evaluation;
...
@EnabledIfEnvironmentVariable(named = "POPCORN_SOCIETY_LIVE_SEARCH_EVALUATION", matches = "true")
class LiveSearchRelevanceEvaluationTest {
  ...
  private SearchRelevanceCase runCase(HttpClient httpClient, JsonNode judgement) throws Exception {
    ...
    String baseUrl =
        System.getenv().getOrDefault("POPCORN_SOCIETY_SEARCH_BASE_URL", "http://localhost:8080");
    HttpRequest request =
