...
import static app.popcornsociety.support.SecurityMockUsers.testAdmin;
...
import app.popcornsociety.catalog.api.MovieSearchReindexJobStatus;
...
import app.popcornsociety.catalog.internal.search.OpenSearchMovieSearchService;
import app.popcornsociety.catalog.internal.search.index.MovieSearchDocument;
import app.popcornsociety.catalog.internal.search.index.MovieSearchDocumentRepository;
...
class SearchControllerTest extends BaseControllerIntegrationTest {
  ...
  @Autowired
  private app.popcornsociety.catalog.internal.search.index.MovieSearchReindexJobs reindexJobs;

  @Autowired
  private app.popcornsociety.catalog.internal.search.index.MovieSearchReindexWorker reindexWorker;
  ...
  void indexSeedMovies() {
    app.popcornsociety.support.SearchIndexFixture.rebuild(reindexJobs, reindexWorker);
  }
