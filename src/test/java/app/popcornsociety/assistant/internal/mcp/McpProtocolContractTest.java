...
import app.popcornsociety.assistant.internal.security.McpSecurityProperties;
...
import app.popcornsociety.catalog.api.MovieSearch;
import app.popcornsociety.catalog.api.MovieSearchRequest;
...
@SpringBootTest(
    ...
    properties = {
      "popcorn-society.assistant.mcp.bearer-token=contract-test-token",
...
class McpProtocolContractTest {
  ...
  @org.springframework.test.context.bean.override.mockito.MockitoBean
  private app.popcornsociety.engagement.api.AssistantWatchlist personalWatchlist;

  @org.springframework.test.context.bean.override.mockito.MockitoBean
  private app.popcornsociety.engagement.api.AssistantRatings personalRatings;

  @org.springframework.test.context.bean.override.mockito.MockitoBean
  private app.popcornsociety.engagement.api.AssistantRatingLibrary ratingLibrary;

  @org.springframework.test.context.bean.override.mockito.MockitoBean
  private app.popcornsociety.recommendation.api.PersonalRecommendationService
      personalRecommendations;

  @org.springframework.test.context.bean.override.mockito.MockitoBean
  private app.popcornsociety.catalog.api.MovieEnrichment enrichment;

  @org.springframework.test.context.bean.override.mockito.MockitoBean
  private app.popcornsociety.catalog.api.MovieWatchProviders watchProviders;
  ...
  void metadataDelegationDeterminesTheAccountAndCommittedReceipt() throws Exception {
    ...
    org.mockito.Mockito.when(delegation.verify("synthetic-delegation", "watchlist:add"))
        .thenReturn(new app.popcornsociety.identity.api.ConciergeDelegation.Actor(7L, "binding"));
    org.mockito.Mockito.when(personalWatchlist.add(7L, 42L, operation))
        .thenReturn(
            new app.popcornsociety.engagement.api.AssistantWatchlist.Receipt(
  ...
  void personalMutationToolsRequireTheirOwnDelegationScopeAndPassTheExplicitScore()
    ...
    org.mockito.Mockito.when(
        ...
        .thenReturn(
            new app.popcornsociety.engagement.api.AssistantActionReceipt(
                operation,
                42L,
                "rating_set",
                true,
