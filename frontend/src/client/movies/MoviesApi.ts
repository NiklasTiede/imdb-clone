import {Configuration, MovieControllerApi, AccountControllerApi, CommentControllerApi, WatchedMovieControllerApi, RatingControllerApi, AuthenticationControllerApi} from './generator-output';
