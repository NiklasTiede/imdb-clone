...
function AppBarTop() {
            ...
            {settings.map((setting) => (
                <MenuItem key={setting.name} onClick={handleMenuClose}>
                    <Typography textAlign="center">
                        <Link style={{textDecoration: "none", color: "inherit"}} to={`${setting.to}`}>
                            {setting.text}
                        </Link>
                    </Typography>
                </MenuItem>
    ...
    const renderMobileMenu = (
        ...
        >
            ...
            <MenuItem onClick={handleProfileMenuOpen} style={{color: colors.grey["100"]}}>
                <IconButton
                    size="large"
        ...
        <Box sx={{flexGrow: 1}}>
            <AppBar position="static">
                <Toolbar>
                    ...
                    <Box sx={{flexGrow: 1}}/>
                    <IconButton onClick={colorMode.toggleColorMode} size="large" aria-label="show 4 new mails"
                                color="inherit">
                        <Badge>
